/**
 * React Flow Implementation (Archived)
 * This version uses React Flow's parentId nesting model
 * Archived in favor of Konva implementation with absolute positioning
 */
...
export default function ReactFlowOldPage() {
  return (
    <DiagramProvider>
